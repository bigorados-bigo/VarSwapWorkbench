...
// Temporarily disabled to allow GetGlyphRangesJapanese() and other functions
...
#define IMGUI_DISABLE_DEBUG_TOOLS                         // Disable metrics/debugger window: ShowMetricsWindow() will be empty.
